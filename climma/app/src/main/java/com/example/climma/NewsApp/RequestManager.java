...
public class RequestManager {
    ...
    Context mContext;
    Retrofit mretrofit = new Retrofit.Builder().baseUrl("https://newsapi.org/v2/")
            .addConverterFactory(GsonConverterFactory.create()).build();

    public void getNewsHeadlines(OnFetchDataListener<NewsApiResponse> listener, String category, String query){
        CallNewsApi callNewsApi = mretrofit.create(CallNewsApi.class);
    ...
    public RequestManager(Context mContext) {this.mContext = mContext;}
